...
train_set = single_cell_dataset(datadir +'images_X' + fs + 'data-images' + fs + 'train' + fs) # + 'train_series.zip')
test_set = single_cell_dataset(datadir +'images_X' + fs + 'data-images' + fs + 'test' + fs) # + 'test_series.zip')
...
train_loader = DataLoader(train_set, batch_sampler = train_coherentsampler, pin_memory = pinning, num_workers = 4)
test_loader = DataLoader(test_set, batch_sampler = test_coherentsampler, pin_memory = pinning, num_workers = 4)
